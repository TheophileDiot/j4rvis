...
module.exports = async (bot, messageReaction, user) => {
    ...
    try {
        ...
        if(["🐺", "📖", "💪", "🎦", "🃏", "🐉", "👨‍💻", "✏️"].includes(messageReaction.emoji.name) && (message.channel.id === channel_change.id || message.channel.id === channel_test.id) ) {
            switch (messageReaction.emoji.name) {
                case "🐺":
                    ...
                    if(member.roles.cache.has(modoJdr.id)) {
                      message.channel
                          .send(`${member.user} vous êtes modérateur de l'activité ${jdr.name}, vous ne pouvez changer d'activité, veuillez contacter un ${moderateur.name} ou un ${administrateur.name} si vous souhaitez que l'on vous destitue de ce rôle.`);
                      break;
                    ...
                    if(member.roles.cache.has(modoCodingDojo.id)) {
                      message.channel
                          .send(`${member.user} vous êtes modérateur de l'activité ${codingDojo.name}, vous ne pouvez changer d'activité, veuillez contacter un ${moderateur.name} ou un ${administrateur.name} si vous souhaitez que l'on vous destitue de ce rôle.`);
                      break;
                    ...
                    if(member.roles.cache.has(loupsGarous.id)){
                        ...
                        message.channel
                            .send(`le rôle ${loupsGarous.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "📖":
                    ...
                    if(member.roles.cache.has(revision.id)){
                        ...
                        message.channel
                            .send(`le rôle ${revision.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "💪":
                    ...
                    if(member.roles.cache.has(sport.id)){
                        ...
                        message.channel
                            .send(`le rôle ${sport.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "🎦":
                    ...
                    if(member.roles.cache.has(cinema.id)){
                        ...
                        message.channel
                            .send(`le rôle ${cinema.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "🃏":
                    ...
                    if(member.roles.cache.has(cycle.id)){
                        ...
                        message.channel
                            .send(`le rôle ${cycle.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "🐉":
                    ...
                    if(member.roles.cache.has(jdr.id)){
                        ...
                        message.channel
                            .send(`le rôle ${jdr.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "👨‍💻":
                    ...
                    if(member.roles.cache.has(codingDojo.id)) {
                        ...
                        message.channel
                            .send(`le rôle ${codingDojo.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
                ...
                case "✏️":
                    ...
                    if(member.roles.cache.has(graphisme.id)) {
                        ...
                        message.channel
                            .send(`le rôle ${graphisme.name} a été ajouté à ${member.user.username} avec succès`)
                            .then(msg => {
                              msg.delete({ timeout: 2500 })
                            });
                    }
