...
module.exports = {
  ...
  run: async (bot, message) => {
    ...
    const admin = message.guild.roles.cache.find(r => r.name === "Administrateur");
    ...
    const channel_appel = message.guild.channels.cache.get("770994425395806208");
    ...
    const channel_esport = message.guild.channels.cache.get('760822841847054357');
    ...
    const channel_magic = message.guild.channels.cache.get('762648055534714891');
    const channel_poker = message.guild.channels.cache.get('762650154116579358');
    const channel_lecture = message.guild.channels.cache.get('762649202005770251');
    const channel_cine_club = message.guild.channels.cache.get('763000551582859286');
    const channel_journal_intech = message.guild.channels.cache.get('763000652167118868');
